...
chef-server-ctl user-create xavki xav ki xavki@moi.fr 'password' --filename /home/vagrant/certs/xavki.pem
chef-server-ctl org-create xavorg "Test xavki" --association_user xavki --filename /home/vagrant/certs/xavorg.pem

mkdir -p /root/.ssh
cp /vagrant/sshkey.pub /root/.ssh/authorized_keys

echo "Chef Console is ready: http://chef-server with login: xavki password: password"
